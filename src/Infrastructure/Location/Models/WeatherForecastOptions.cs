...
namespace Infrastructure.Location.Models
{
    public class WeatherForecastOptions
    {
        ...
        public WeatherForecastOptions(float latitude, float longitude, TemperatureUnitType temperature_Unit, WindspeedUnitType windspeed_Unit, PrecipitationUnitType precipitation_Unit, string timezone, bool current_Weather, TimeformatType timeformat, int past_Days, string start_date, string end_date)
        {
            Latitude = latitude;
            Longitude = longitude;
